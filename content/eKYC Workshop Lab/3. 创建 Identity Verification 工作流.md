...
**粘贴以下代码，注意有一处配置需要修改:**
  - TopicArn： 将 ```arn:aws:sns:ap-northeast-1:xxxxxx:ekyc-fail-notification``` 中的 xxx 替换为您的账户 ID
...
**粘贴以下代码，注意有两处配置需要修改:**
 ...
 2. StateMachineArn： 将 ```arn:aws:states:ap-northeast-1:xxxxxx:stateMachine:ekyc-workshop-identity-compare``` 中的 xxx 替换为您的账户 ID
